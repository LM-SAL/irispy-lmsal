...
date_obs_load5 = iris_response_load5.date_obs
lamb_load5 = iris_response_load5.lambda_vars
area_sg_load5 = iris_response_load5.area_sg
name_sg_load5 = iris_response_load5.name_sg
dn2phot_sg_load5 = iris_response_load5.dn2phot_sg
area_sji_load5 = iris_response_load5.area_sji
name_sji_load5 = iris_response_load5.name_sji
dn2phot_sji_load5 = iris_response_load5.dn2phot_sji
comment_load5 = iris_response_load5.comment
version_load5 = iris_response_load5.version
version_date_load5 = iris_response_load5.version_date
...
date_obs_load6 = iris_response_load6.date_obs
lamb_load6 = iris_response_load6.lambda_vars
area_sg_load6 = iris_response_load6.area_sg
name_sg_load6 = iris_response_load6.name_sg
dn2phot_sg_load6 = iris_response_load6.dn2phot_sg
area_sji_load6 = iris_response_load6.area_sji
name_sji_load6 = iris_response_load6.name_sji
dn2phot_sji_load6 = iris_response_load6.dn2phot_sji
comment_load6 = iris_response_load6.comment
version_load6 = iris_response_load6.version
version_date_load6 = iris_response_load6.version_date
...
@pytest.mark.remote_data
def iris_response5():
    # For testing of version 5
    return utils.get_iris_response(time_obs=parse_time("2013-09-03", format="utime"), response_version=5)

@pytest.fixture
@pytest.mark.remote_data
def iris_response6():
    # For testing of version 6
    return utils.get_iris_response(time_obs=parse_time("2013-09-03", format="utime"), response_version=6)
...
@pytest.mark.remote_data
def test_get_iris_response_version5(iris_response5):
    np_test.assert_almost_equal(iris_response5["AREA_SG"].value, area_sg_load5, decimal=3)
    np_test.assert_almost_equal(iris_response5["AREA_SJI"].value, area_sji_load5, decimal=3)

@pytest.mark.remote_data
def test_get_iris_response_version6(iris_response6):
    np_test.assert_almost_equal(iris_response6["AREA_SG"].value, area_sg_load6, decimal=3)
    np_test.assert_almost_equal(iris_response6["AREA_SJI"].value, area_sji_load6, decimal=3)
