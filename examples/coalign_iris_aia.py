...
aia_crop = aia_map.submap(sji_map.bottom_left_coord, top_right=sji_map.top_right_coord)
...
aia_crop.draw_contours(levels=[500] * u.DN, colors=["red"], linewidths=2)
...
coaligned_sji_map = coalign(sji_map_corrected, aia_crop, method="match_template")

fig = plt.figure()
ax1 = fig.add_subplot(111, projection=aia_map.wcs)
